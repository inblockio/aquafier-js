            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                  ...
                  <div className="space-y-6">
                        ...
                        <section>
                              ...
                              <p className="mb-3">You represent and warrant that you have all necessary rights, permissions, and authority to share any documents or content on the Platform.</p>
                        </section>
                        ...
                        <section>
                              ...
                              <p className="mb-3">If you have any questions about these Terms and Conditions, please contact us at legal@aquaprotocol.io.</p>
                        </section>
                  </div>
            </div>
      )
