import LoadConfiguration from './components/layout/config'
...
import PdfWorkflowPage from './pages/pdf_workflow/PdfWorkflowPage'
import FilesSharedContracts from './pages/files_share/files_shared_contracts'
import WorkflowsTablePage from './pages/pdf_workflow/WorkflowsTablePage'
            ...
            <ErrorBoundary>
                <Routes>
                    ...
                    <Route path="/app" element={<NewShadcnLayoutWithSidebar />}>
                        ...
                        <Route path="workflows/aqua_certificate" element={<AquaCertWorkflows />} />
                        <Route path="workflows/aqua_sign" element={<WorkflowsTablePage />} />
