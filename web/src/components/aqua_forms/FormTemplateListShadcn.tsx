                  ...
                  <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
                        <DialogContent className="sm:max-w-[700px] max-h-[90vh] flex flex-col">
                              ...
                              <div className="flex-grow overflow-y-auto py-4">
                                    ...
                                    {viewType === 'create_instance' && templateToView && (
                  ...
                  <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                        <AlertDialogContent>
                              <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>Are you sure you want to delete the "{templateToDelete?.title}" template? This action cannot be undone.</AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                    <AlertDialogCancel data-testid="cancel-delete-form-action-button" disabled={isLoading}>
                                          Cancel
                                    </AlertDialogCancel>
                                    <AlertDialogAction
