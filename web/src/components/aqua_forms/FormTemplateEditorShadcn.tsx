...
const FormTemplateEditorShadcn = ({
    initialTemplate,
    onSave,
    updating,
}: FormTemplateEditorShadcnProps) => {
    const {
        session,
        backend_url,
        setFormTemplate,
        ...
        <div>
            ...
            <form
                onSubmit={handleSubmit(handleFormSubmit, errors => {
                    ...
                    toast.error(
                        'Please fix the form errors before submitting (more thatn 3 characters  and atleast one form field is required)'
                    )
                })}
                className="space-y-6"
            >
                ...
                <div className="space-y-4">
                    {templateFormFields.map(field => (
                        <div
                            key={field.name}
                            className={field.name === 'name' ? 'hidden' : ''}
                        >
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    {...register(
                                        field.name as keyof FormTemplate,
                                        {
                    ...
                    {formFields.map((field, index) => (
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                {/* Type Field */}
                                <div className="space-y-2">
                                    <Label htmlFor={`field-type-for-${index}`}>
                                        Type
                                    </Label>
                                    <CustomSelect
                                        id={`field-type-${index}`}
                                        ...
                                        value={field.type}
                                        onChange={newVal =>
                                            updateFields(index, 'type', newVal)
                                        }
                                    />
                                </div>
