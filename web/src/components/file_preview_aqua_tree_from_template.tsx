...
export const FilePreviewAquaTreeFromTemplateOne = ({
    userData,
}: {
        ...
        >
            ...
            <div className="p-6">
                {Object.keys(userData).map(keyItem => (
                    <div
                        key={keyItem}
                        className={`p-4 rounded-xl mb-4 transition-transform hover:scale-101 ${isDarkMode ? 'bg-slate-700' : 'bg-slate-50'}`}
                    >
                        ...
                        <div
                            className={`font-medium ${isDarkMode ? 'text-slate-50' : 'text-slate-800'}`}
                        >
                            {userData[keyItem]}
                        </div>
                    </div>
...
export const FilePreviewAquaTreeFromTemplate = ({
    formData,
}: {
                    ...
                    {keys.sort().map((keyItem, index: number) => (
                        ...
                        >
                            <td className="p-3 font-medium">
                                {makeProperReadableWord(keyItem)}
                            </td>
                            <td className="p-3">
                                <div className="flex items-start justify-between">
                                    ...
                                    <ClipboardButton
                                        ...
                                        visible={checkCopyButtonVisibility(
                                            keyItem
                                        )}
                                    />
                                </div>
