      ...
      return (
            <StatRoot shadow={'sm'} borderRadius={'xl'} px={'4'} py="6" h={'100%'}>
                  <Group align="center" gap="md">
                        <Box display="flex" alignItems="center" justifyContent="center" w={{ base: '40px', md: '60px' }} h={{ base: '40px', md: '60px' }} overflow={'hidden'} borderRadius="md">
                              <Image src={props.image} alt={`${props.title} icon`} objectFit="contain" w={'100%'} h={'100%'} maxWidth={'60px'} maxHeight={'60px'} />
                        </Box>
                  ...
                  <StatHelpText mt={'2'} fontWeight={400} fontSize={'medium'} display={'inline-flex'} alignItems="center">
                        {props.size}
                        <LuDot />
                        {`${props.files} Files`}
                  </StatHelpText>
