...
const getLogTypeStyles = (logType: LogType) => {
    const baseStyles =
        'px-4 py-2 mb-1 border-l-4 rounded-r-lg font-mono text-sm leading-relaxed transition-all hover:shadow-sm'
...
const LogLine: React.FC<{ entry: LogData; index: number }> = ({
    entry,
    index,
}) => {
