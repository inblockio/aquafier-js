            ...
            <>
                  ...
                  <Dialog open={isOpen} onOpenChange={setIsOpen}>
                        <DialogContent className="max-w-lg">
                              <DialogHeader>
                                    <DialogTitle className="text-lg">{`Link ${item.fileObject[0].fileName} To another file (Aquatree)`}</DialogTitle>
                              </DialogHeader>
                              ...
                              <div className="space-y-4">
                                    {files?.length <= 1 ? (
                                          <Alert className="border-orange-200 bg-orange-50">
                                                ...
                                                <AlertDescription className="text-orange-700">For linking to work you need multiple files, currently you only have {files?.length}.</AlertDescription>
                                          </Alert>
                                    ) : (
                                          <div className="space-y-4 text-left">
                                                ...
                                                <p className="text-sm font-medium">Select the file you want to link to.</p>
                                                                  ...
                                                                  return (
                                                                        <div key={index} className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded">
                                                                              ...
                                                                              <div className="flex items-center space-x-2 flex-1">
                                                                                    ...
                                                                                    />
                                                                                    <Label htmlFor={`file-${index}`} className="text-sm cursor-pointer flex-1">
                              ...
                              <DialogFooter className="flex justify-between">
                                    <Button variant="outline" onClick={cancelClick} data-testid="link-cancel-action-button">
                                          Cancel
                                    </Button>

                                    {files?.length > 1 && (
                                          <Button onClick={handleLink} disabled={linking || linkItem === null} data-testid="link-modal-action-button-dialog">
                                                {linking ? (
                                                      <>
