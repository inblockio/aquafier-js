      ...
      const deleteFileAction = async () => {
            ...
            for (const anAquaTree of files.fileData) {
                  ...
                  if (genesisHash == genesisOfFileBeingDeleted) {
                        ...
                        if (!isWorkFlow) {
                              const indexValues = Object.values(anAquaTree.aquaTree!.file_index)
                  ...
                  <Dialog open={open} onOpenChange={setOpen}>
                        <DialogContent className="sm:max-w-[425px] ">
                              <DialogHeader>
                                    ...
                                    <DialogDescription>The following aqua trees will become corrupt, as they reference the file you are about to delete</DialogDescription>
                              </DialogHeader>
                              <div className="py-4">
                              ...
                              <DialogFooter className="flex flex-row justify-end space-x-2">
                                    <Button data-testid="cancel-delete-file-action-button" variant="outline" size="sm" onClick={() => setOpen(false)}>
                                          Cancel
                                    </Button>
                                    <Button data-testid="proceed-delete-file-action-button" onClick={() => deleteFileApi()} size="sm" variant="destructive" className="flex items-center space-x-1">
