        ...
        <>
            {
                ...
                setSelectedFileInfo(file);
                    ...
                    <Button data-testid={"open-aqua-claim-workflow-button-"+index} className="w-full flex items-center justify-center space-x-1 bg-green-100 text-green-700 px-2 py-2 rounded hover:bg-green-200 transition-colors text-xs" onClick={(e) => {
                       setOpenFileDetailsPopUp(true);
                setSelectedFileInfo(file);
                    }} >
