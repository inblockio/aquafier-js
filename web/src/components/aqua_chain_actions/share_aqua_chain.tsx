            ...
            <>
                  ...
                  <Dialog open={isOpenState} onOpenChange={setIsOpenChange}>
                        <DialogContent className="max-w-md">
                              <DialogHeader>
                                    <DialogTitle className="text-lg font-semibold">Sharing {fileName}</DialogTitle>
                              </DialogHeader>
                                          ...
                                          <div className="space-y-2">
                                                ...
                                                <div
                                                      className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-colors ${
                                                            optionType === 'latest' ? 'border-blue-500 bg-orange-100/80' : 'border-gray-200 hover:border-gray-300'
                                                      }`}
                                                ...
                                                >
                                                      ...
                                                      <div
                                                            className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                                                                  optionType === 'latest' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                                                            }`}
                                                      >
                                                ...
                                                <div
                                                      className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-colors ${
                                                            optionType === 'current' ? 'border-blue-500 bg-orange-100/80' : 'border-gray-200 hover:border-gray-300'
                                                      }`}
                                                ...
                                                >
                                                      ...
                                                      <div
                                                            className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                                                                  optionType === 'current' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                                                            }`}
                                                      >
                              ...
                              <DialogFooter className="flex justify-between">
                                    <Button variant="outline" onClick={() => setIsOpenChange(false)} data-testid="share-cancel-action-button">
                                          Cancel
                                    </Button>
