                  ...
                  <div className="space-y-6">
                        ...
                        <section>
                              ...
                              <ul className="list-disc pl-6 space-y-2">
                                    <li>
                                          <strong>Personal Information:</strong> Ethereum addresses, email addresses, and other contact information you provide.
                                    </li>
                                    <li>
                                          <strong>Usage Data:</strong> Information about how you use our Platform, including your browsing actions and patterns.
                                    </li>
                                    <li>
                                          <strong>Document Data:</strong> Content of documents you upload, share, or sign through our Platform.
                                    </li>
                                    <li>
                                          <strong>Blockchain Data:</strong> Transaction information that is recorded on the blockchain.
                                    </li>
                              </ul>
                        </section>
                        ...
                        <section>
                              ...
                              <p className="mb-3">If you have any questions about this Privacy Policy, please contact us at privacy@aquaprotocol.io.</p>
                        </section>
                  </div>
            </div>
      )
