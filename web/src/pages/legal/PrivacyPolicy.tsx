        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="space-y-6">
                <section>
                    ...
                    <p className="mb-3">
                        At Aqua Protocol, we respect your privacy and are committed to protecting
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        <li>
                            <strong>Personal Information:</strong> Ethereum addresses, email
                            addresses, and other contact information you provide.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Document Data:</strong> Content of documents you upload, share,
                            or sign through our Platform.
                        </li>
                        <li>
                            <strong>Blockchain Data:</strong> Transaction information that is
                ...
                <section>
                    ...
                    <p className="mb-3">
                        Please be aware that blockchain technology is inherently transparent and
                        public. When you use our Platform to record information on a blockchain,
                        that information becomes publicly available. While we do not directly
                        publish your personal information on the blockchain, transaction data
                        including Ethereum addresses are recorded and visible on the blockchain.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="mb-3">
                        ...
                        information. However, no method of transmission over the Internet or method
                ...
                <section>
                    ...
                    <p className="mt-3">
                        Please note that some of these rights may be limited when information has
                        been recorded on a blockchain, as blockchain data is immutable by design.
                    </p>
                </section>
