        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="space-y-6">
                <section>
                    ...
                    <p className="mb-3">
                        At Aqua Protocol, we respect your privacy and are
                ...
                <section>
                    ...
                    <p className="mb-3">
                        ...
                        about users of our Platform, including:
                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>
                            <strong>Personal Information:</strong> Ethereum
                            addresses, email addresses, and other contact
                            information you provide.
                        </li>
                        <li>
                            <strong>Usage Data:</strong> Information about how
                            you use our Platform, including your browsing
                            actions and patterns.
                        </li>
                        <li>
                            <strong>Document Data:</strong> Content of documents
                            you upload, share, or sign through our Platform.
                        </li>
                        <li>
                            <strong>Blockchain Data:</strong> Transaction
                            information that is recorded on the blockchain.
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li>
                            ...
                            we can improve our Platform
                        </li>
                        <li>To monitor the usage of our Platform</li>
                        <li>To detect, prevent and address technical issues</li>
                        <li>
                            To send you notifications about document sharing and
                            signing activities
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p className="mb-3">
                        ...
                        transparent and public. When you use our Platform to
                        record information on a blockchain, that information
                        becomes publicly available. While we do not directly
                        publish your personal information on the blockchain,
                        transaction data including Ethereum addresses are
                ...
                <section>
                    ...
                    <p className="mt-3">
                        Please note that some of these rights may be limited
                        when information has been recorded on a blockchain, as
                ...
                <section>
                    ...
                    <p className="mb-3">
                        ...
                        please contact us at privacy@aquaprotocol.io.
                    </p>
                </section>
            </div>
        </div>
