...
const PhoneNumberClaim = ({ claim }: { claim: ICompleteClaimInformation }) => {
    ...
    let extraVerificationClasses = ""

    if(claim.attestations.length > 0){
      extraVerificationClasses = "text-green-500"
    }
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="border-t border-gray-100 pt-4 mb-4">
                <p className={`text-sm text-gray-700 ${extraVerificationClasses}`}>Claim verified to "{verifiedTo}"</p>
