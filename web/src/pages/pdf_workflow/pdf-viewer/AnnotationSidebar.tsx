...
const AnnotationSidebar: React.FC<AnnotationSidebarProps> = ({ annotations, onAnnotationUpdate, onAnnotationDelete, selectedAnnotationId, onAnnotationSelect }) => {
      ...
      // ) as ImageAnnotation[];
      const profileAnnotations = annotations.filter(anno => anno.type === 'profile') as ProfileAnnotation[]
      const signatureAnnotations = annotations.filter(anno => anno.type === 'signature') as SignatureData[]
                        ...
                        <div className="p-2">
                              <div className="flex flex-col space-y-3">
                                    ...
                                    <div className="bg-gray-100 rounded-lg">
                                          <img className="rounded-lg h-24 mx-auto" src={anno.dataUrl} alt={anno.name} data-ai-hint="profile picture" />
                                    </div>
            ...
            <div className="w-96 bg-card border-l p-4 h-full flex flex-col rounded-xl">
                  <div className="border rounded-lg shadow-sm">
                        <div className="p-4 border-b">
                              <h3 className="text-base font-medium flex justify-between items-center">Signatures</h3>
                        </div>
                        <div className="p-4">
