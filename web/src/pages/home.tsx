            ...
            <div className="container mx-auto text-center px-4 relative z-10">
                  <div className="max-w-4xl mx-auto">
                        <h1 className="text-4xl font-bold font-headline tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                              <span className="bg-gradient-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent">AquaFire App</span><br /> Portable and Secure Document Managment, e-Signature and Identity Solution
                        </h1>
                  ...
                  <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <Button size="lg" variant="outline" asChild className="border-orange-500/30 hover:border-orange-500 hover:bg-orange-500/5 transition-all duration-300">
      ...
      <section id="features" className="py-20 md:py-28 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                  <div className="text-center max-w-2xl mx-auto">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">Aqua serves as a versatile building block for a wide range of applications.</p>
                  </div>
...
const prototypes = [
      ...
      },
      {
            ...
            icon: <Chrome className="h-10 w-10 text-orange-500" />,
            cta: 'View in Store',
      },
      {
      ...
      <section id="prototypes" className="py-20 md:py-28 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                  <div className="text-center max-w-2xl mx-auto">
                        ...
                        <div className="h-1 w-20 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto my-6"></div>
                        <p className="mt-4 text-lg text-muted-foreground">The potential of Aqua is being explored through practical implementations.</p>
                  </div>
                  <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {prototypes.map(proto => (
                              <Card
                                    key={proto.name}
                                    className="flex flex-col text-center items-center p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-100 dark:border-orange-900/20 hover:border-orange-200 dark:hover:border-orange-800/30 bg-white/80 dark:bg-black/50 backdrop-blur-sm"
                              >
                                    <CardHeader className="flex flex-col p-0 w-full items-center">
                                          <div className="mb-4 rounded-full bg-orange-500/10 p-4 shadow-inner">{proto.icon}</div>
      ...
      <section id="pricing" className="py-20 md:py-28 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                  <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="h-1 w-20 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto my-6"></div>
                        <p className="mt-4 text-lg text-muted-foreground">Choose the plan that's right for you and start building with Aqua Protocol today.</p>
                  </div>
                              ...
                              >
                                    {plan.popular && (
                                          <div className="absolute top-0 right-0">
                                                <div className="bg-orange-500 text-white text-xs font-semibold px-3 py-1 rounded-bl-lg">Popular</div>
                                          </div>
                                    )}
                                    <CardHeader>
                                          <div className="mb-4 rounded-full bg-orange-500/10 p-3 w-fit">{plan.icon}</div>
