        ...
        <div className="container mx-auto text-center px-4 relative z-10">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-bold font-headline tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                    ...
                    Secure Document Signing & Verification Protocol
                </h1>
...
const HowItWorksSection = () => (
    <section
        id="how-it-works"
        className="py-20 md:py-28 bg-orange-50/20 dark:bg-orange-900/10 relative overflow-hidden"
    >
        {/* Decorative elements */}
...
const prototypes = [
    ...
    },
    {
        ...
        description:
            'A tool for name resolution and AquaTree validation (Aqua Verifier, Protocol v1.2).',
    ...
    },
    {
        ...
        description:
            "Automated access control enforcement integrated with Aqua ('Guardian,' Protocol v1.2).",
        link: null,
...
const visionPoints = [
    {
        ...
        description:
            'Empowering organizations to build private, decentralized solutions for data certification and verification without central authorities.',
    },
    {
        title: 'A Verifiable Data Structure',
        description:
            'Creating tamper-evident records that link and certify data with cryptographic precision, ensuring integrity across distributed systems.',
    },
    {
        title: 'A Protocol for Provenance',
        description:
            'Establishing unbreakable chains of custody that guarantee data origins and transformations with mathematical certainty.',
    },
    {
        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mt-16">
                ...
                <div className="mt-8">
                    ...
                    >
                        <Link
                            to="https://github.com/inblockio/aqua-docs"
                            target="_blank"
        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="mt-16 bg-orange-50/50 dark:bg-orange-900/10 border border-orange-200/50 dark:border-orange-800/30 rounded-xl p-8 text-center">
                ...
                <Button
                    asChild
                    variant="outline"
                    className="mt-6 border-orange-500/30 hover:border-orange-500 hover:bg-orange-500/5"
                >
                    <Link to="#contact">
                        <span className="flex items-center">
                            Contact Sales
