...
const PdfViewer: React.FC<PdfViewerProps> = ({
    ...
    useEffect(() => {
        if (!file || !isPdfjsLibLoaded) {
            ...
            if (
                !file ||
                (file && !isPdfjsLibLoaded && !pdfLoadingError?.includes('library failed to load'))
            ) {
    ...
    const handleResizeMouseMove = useCallback(
        (event: MouseEvent) => {
            ...
            newBlockYPercent = Math.max(
                0,
                Math.min(newBlockYPercent, 100 - parseFloat(finalHeightPercentString))
            );
    ...
    if (annotationsInDocumentOnCurrentPage.length > 1) {
        annotationsOnCurrentPage = annotationsOnCurrentPage.filter(
            e => !annotationsInDocumentOnCurrentPage.some(exist => exist.id == e.id)
        );
    }
    ...
    return (
        <div className="py-4 px-2 h-auto md:h-full" ref={viewerRef} onClick={handleViewerClick}>
            ...
            {file && !isPdfjsLibLoaded && !pdfLoadingError && (
                <p className="text-gray-700 dark:text-gray-400">Initializing PDF viewer...</p>
            )}
                        ...
                        <div className="relative flex flex-col justify-start overflow-x-auto">
                            ...
                            >
                                ...
                                {pageDimensions.width > 0 &&
                                    cleanSignatureToAvoidRepeating().map(anno => {
                                        const isSelected =
                                            selectedAnnotationId === anno.id ||
                                            draggingAnnotationId === anno.id ||
                                            resizeState?.annotationId === anno.id;
                                        ...
                                        if (anno.type === 'text') {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    onMouseDown={e =>
                                                        handleAnnotationMouseDown(e, anno)
                                                    }
                                                >
                                                    <textarea
                                                        value={anno.text}
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style={{
                                                            fontSize:
                                                                profileAnno.nameFontSize || '12pt',
                                                            color:
                                                                profileAnno.nameColor || '#333333',
                                                            fontWeight: 'bold',
                                                            pointerEvents: 'none',
                                                        }}
                                                    >
                                ...
                                {annotationsInDocumentOnCurrentPage.map(profileAnno => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={profileStyle}
                                            data-ai-hint="profile annotation"
                                            data-annotation-id={profileAnno.id}
                                            onMouseDown={e =>
                                                handleAnnotationMouseDown(e, profileAnno)
                                            }
                                        >
                                            <div
                                                className="relative"
                                            ...
                                            <div
                                                style={{
                                                    fontSize:
                                                        profileAnno.walletAddressFontSize || '10pt',
                                                    color:
                                                        profileAnno.walletAddressColor || '#555555',
                                                    pointerEvents: 'none',
                                                    wordBreak: 'break-all',
                                                }}
                                            >
                            ...
                            {pdfDoc &&
                                ...
                                !pdfLoadingError && (
                                    <p className="absolute" style={{ color: 'gray.700' }}>
