        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="space-y-1">
            ...
            <input 
              ...
              onChange={(e) => onAnnotationUpdate({ ...anno, dataUrl: e.target.value })} 
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <input 
              ...
              onChange={(e) => onAnnotationUpdate({ ...anno, name: e.target.value })} 
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <input 
              ...
              onChange={(e) => onAnnotationUpdate({ ...anno, walletAddress: e.target.value })} 
            />
          </div>
