...
export const ContractDocumentView: React.FC<ContractDocumentViewProps> = ({ setActiveStep }) => {
    ...
    const loadSignatures = async (): Promise<SignatureData[]> => {
        ...
        for (const sigHash of signatureRevionHashes) {
            ...
            const revisionSigImage =
                selectedFileInfo!.aquaTree!.revisions[sigHash.revisionHashWithSinatureRevision];
            const linkRevisionWithSignaturePositions: Revision =
                selectedFileInfo!.aquaTree!.revisions[sigHash.revisionHashWithSignaturePosition];
            const revisionMetMask: Revision =
                selectedFileInfo!.aquaTree!.revisions[sigHash.revisionHashMetamask];
    ...
    const firstRevision =
        selectedFileInfo.aquaTree.revisions[Object.keys(selectedFileInfo.aquaTree.revisions)[0]];
