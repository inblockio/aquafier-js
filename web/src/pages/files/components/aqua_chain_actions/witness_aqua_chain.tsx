    ...
    return (
        <>
            ...
            <button
                ...
                className={`flex items-center space-x-1 bg-gray-800  text-white px-3 py-2 rounded-md transition-colors text-xs ${witnessing ? 'opacity-60 cursor-not-allowed' : 'hover:bg-blue-200'}`}
                disabled={witnessing}
            >
                {witnessing ? (
                    <>
