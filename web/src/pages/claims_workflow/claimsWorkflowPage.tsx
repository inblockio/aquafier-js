                        ...
                        <div className="container mx-auto py-4 px-1 md:px-4">
                              ...
                              <div className="border-b border-gray-200">
                                    <div className="flex space-x-0">
                                          {tabs.map(tab => {
                                                ...
                                                if (tab.id === 'shared_data' && processedInfo?.walletAddress !== session?.address) {
                                                      return null
                                                }
                                            ...
                                            ${isActive ? 'text-gray-900 border-gray-900' : 'text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300'}
                                            `}
                                                      >
                              ...
                              <div className="sm:p-2 md:p-6 mt-4">
                                    <div className="flex items-center justify-between mb-6">
                                          <h1 className="text-2xl font-semibold text-gray-900 capitalize">{activeTabData?.label}</h1>

                                          {processedInfo?.walletAddress === session?.address && activeTabData?.id == `claims_summary` ? (
                                                ...
                                                <span className="text-sm text-gray-900">
                                                    {
                                                      ...
                                                      {renderClaim(processedInfo?.claimInformation!)}
                                                </div>
                                          )}

                                          {activeTab === 'shared_data' && processedInfo.walletAddress === session?.address && (
                                                <div>
                                                      <div className="bg-gray-50 rounded-lg p-6">
                                                            <p className="text-gray-900">Wallets that you have shared the claim with</p>
