...
const start = async () => {
  try {
    ...
    await fastify.register(cors, {
      ...
      origin: ['http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:3000', 'http://127.0.0.1:3000', 'http://localhost:3600', 'http://127.0.0.1:3600'], // Allow your React app origins
