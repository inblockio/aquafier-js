...
-- CreateTable
CREATE TABLE IF NOT EXISTS "aqua_templates" (
    "id" TEXT NOT NULL,
    "owner" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "name" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "aqua_templates_fields" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "user_attestation_addresses" (
    "id" TEXT NOT NULL,
    "owner" TEXT NOT NULL,
    "address" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "siwe_session" (
    "id" SERIAL NOT NULL,
    "address" TEXT NOT NULL,
    "nonce" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "witness_event" (
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "aqua_forms" (
    "id" TEXT NOT NULL,
    "hash" TEXT NOT NULL,
    "key" TEXT,
    "value" JSONB,
