...
const EmailClaim = ({ claim }: { claim: ICompleteClaimInformation }) => {
    ...
    const verifiedTo = claimInfo['forms_email']
            ...
            <div className="flex items-center gap-3 mb-4 justify-between">
                <div className="flex items-center gap-2">
                    <div className={`bg-${isVerified ? "green" : "gray"}-50 p-2 rounded-lg`}>
                        <Mail className={isVerified ? "text-green-500 w-6 h-6" : "text-gray-500 w-6 h-6"} />
                    </div>
                    <div>
